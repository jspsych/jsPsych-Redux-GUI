module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            component_timeline_form: 'src/common/components/TimelineNode/TimelineForm',
            ...
            component_table: 'src/common/components/TimelineNode/EditableTable/EditableTable',
            component_rows: 'src/common/components/TimelineNode/EditableTable/Rows',
            component_columns: 'src/common/components/TimelineNode/EditableTable/Columns',
            ...
            container_timeline_form: 'src/common/containers/TimelineNode/TimelineForm.js',
            container_table: 'src/common/containers/TimelineNode/EditableTable/EditableTable.js',
            container_column: 'src/common/containers/TimelineNode/EditableTable/Column.js',
            actions: 'src/common/actions/timelineNodeActions.js',
            actions_trial_form: 'src/common/actions/trialFormActions.js',
            actions_table_actions: 'src/common/action/tableActions.js',
