...
a/2+"px;",1==c[g][k]&&(d+="border: 2px solid black;"),"undefined"!==typeof e&&e[0]==g&&e[1]==k&&(d+="background-color: "+f+";"),d+="'>","undefined"!==typeof b&&!1!==b[g][k]&&(d+=b[g][k]),d+="</div>";d+="</div>"}return d+"</div>"};return d}();jsPsych.plugins["survey-likert"]=function(){var d={};d.info={name:"survey-likert",description:"",parameters:{questions:{type:jsPsych.plugins.parameterType.STRING,array:!0,pretty_name:"Questions","default":void 0,description:"Questions that are associated with the slider."},labels:{type:jsPsych.plugins.parameterType.STRING,array:!0,pretty_name:"Labels","default":void 0,description:"Labels to display for individual question."},preamble:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Preamble",
"default":"",description:"String to display at top of the page."},required:{type:jsPsych.plugins.parameterType.BOOL,array:!0,pretty_name:"Required","default":!1,description:"Makes answering questions required."},button_label:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Button label","default":"Next",description:"Label of the button."}}};d.trial=function(c,a){var e="<style id=\"jspsych-survey-likert-css\">.jspsych-survey-likert-statement { display:block; font-size: 16px; padding-top: 40px; margin-bottom:10px; }.jspsych-survey-likert-opts { list-style:none; width:100%; margin:0; padding:0 0 35px; display:block; font-size: 14px; line-height:1.1em; }.jspsych-survey-likert-opt-label { line-height: 1.1em; color: #444; }.jspsych-survey-likert-opts:before { content: ''; position:relative; top:11px; /*left:9.5%;*/ display:block; background-color:#efefef; height:4px; width:100%; }.jspsych-survey-likert-opts:last-of-type { border-bottom: 0; }.jspsych-survey-likert-opts li { display:inline-block; /*width:19%;*/ text-align:center; vertical-align: top; }.jspsych-survey-likert-opts li input[type=radio] { display:block; position:relative; top:0; left:50%; margin-left:-6px; }</style>"+
('<div id="jspsych-survey-likert-preamble" class="jspsych-survey-likert-preamble">'+a.preamble+"</div>");e+='<form id="jspsych-survey-likert-form">';for(var f=0;f<a.questions.length;f++){e+='<label class="jspsych-survey-likert-statement">'+a.questions[f]+"</label>";for(var b=100/a.labels[f].length,d='<ul class="jspsych-survey-likert-opts" data-radio-group="Q'+f+'">',g=0;g<a.labels[f].length;g++)d+='<li style="width:'+b+'%"><input type="radio" name="Q'+f+'" value="'+g+'"',a.required&&(d+=" required"),
d+='><label class="jspsych-survey-likert-opt-label">'+a.labels[f][g]+"</label></li>";d+="</ul>";e+=d}e+='<input type="submit" id="jspsych-survey-likert-next" class="jspsych-survey-likert jspsych-btn" value="'+a.button_label+'"></input>';c.innerHTML=e+"</form>";c.querySelector("#jspsych-survey-likert-form").addEventListener("submit",function(a){a.preventDefault();a=(new Date).getTime()-k;for(var b={},e=c.querySelectorAll("#jspsych-survey-likert-form .jspsych-survey-likert-opts"),d=0;d<e.length;d++){var f=
e[d].dataset.radioGroup;var g=c.querySelector('input[name="'+f+'"]:checked');g=null===g?"":parseInt(g.value);var h={};h[f]=g;Object.assign(b,h)}a={rt:a,responses:JSON.stringify(b)};c.innerHTML="";jsPsych.finishTrial(a)});var k=(new Date).getTime()};return d}();jsPsych.plugins["survey-multi-choice"]=function(){var d={};d.info={name:"survey-multi-choice",description:"",parameters:{questions:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Questions",array:!0,"default":void 0,description:"The strings that will be associated with a group of options."},options:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Options",array:!0,"default":void 0,description:"Displays options for an individual question."},required:{type:jsPsych.plugins.parameterType.BOOL,
pretty_name:"Required",array:!0,"default":!1,description:"Subject will be required to pick an option for each question."},horitzontal:{type:jsPsych.plugins.parameterType.BOOL,pretty_name:"Horitzontal","default":!1,description:"If true, then questions are centered and options are displayed horizontally."},preamble:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Preamble","default":"",description:"HTML formatted string to display at the top of the page above all the questions."},button_label:{type:jsPsych.plugins.parameterType.STRING,
pretty_name:"Button label","default":"",description:"Label of the button."}}};d.trial=function(c,a){var e=function(){return Array.prototype.slice.call(arguments,e.length).join(separator="-")};c.innerHTML='<style id="jspsych-survey-multi-choice-css"></style>';c.querySelector("#jspsych-survey-multi-choice-css").innerHTML=".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: 2em; text-align: left; }.jspsych-survey-multi-choice-text span.required {color: darkred;}.jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-text {  text-align: center;}.jspsych-survey-multi-choice-option { line-height: 2; }.jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {  display: inline-block;  margin-left: 1em;  margin-right: 1em;  vertical-align: top;}label.jspsych-survey-multi-choice-text input[type='radio'] {margin-right: 1em;}";
var d=e("jspsych-survey-multi-choice","form");c.innerHTML+='<form id="'+d+'"></form>';var d=c.querySelector("#"+d),b=e("jspsych-survey-multi-choice","preamble");d.innerHTML+='<div id="'+b+'" class="'+b+'">'+a.preamble+"</div>";for(b=0;b<a.questions.length;b++){var h=[e("jspsych-survey-multi-choice","question")];a.horizontal&&h.push(e("jspsych-survey-multi-choice","horizontal"));d.innerHTML+='<div id="'+e("jspsych-survey-multi-choice",b)+'" class="'+h.join(" ")+'"></div>';h=e("#jspsych-survey-multi-choice",
b);c.querySelector(h).innerHTML+='<p class="jspsych-survey-multi-choice-text survey-multi-choice">'+a.questions[b]+"</p>";for(var g=0;g<a.options[b].length;g++){var k=e("jspsych-survey-multi-choice","option",b,g);c.querySelector(h).innerHTML+='<div id="'+k+'" class="'+e("jspsych-survey-multi-choice","option")+'"></div>';var k=document.getElementById(k),m=e("jspsych-survey-multi-choice","response",b),l=e("jspsych-survey-multi-choice","response",b,g),p=document.createElement("label");p.setAttribute("class",
"jspsych-survey-multi-choice-text");p.innerHTML=a.options[b][g];p.setAttribute("for",l);var n=document.createElement("input");n.setAttribute("type","radio");n.setAttribute("name",m);n.setAttribute("id",l);n.setAttribute("value",a.options[b][g]);k.appendChild(p);k.insertBefore(n,p)}a.required&&a.required[b]&&(c.querySelector(h+" p").innerHTML+="<span class='required'>*</span>",c.querySelector(h+" input[type=radio]").required=!0)}d.innerHTML+='<input type="submit" id="jspsych-survey-multi-choice-next" class="jspsych-survey-multi-choice jspsych-btn"'+
...
c.innerHTML="";jsPsych.finishTrial(a)});var q=(new Date).getTime()};return d}();jsPsych.plugins["survey-multi-select"]=function(){var d={};d.info={name:"survey-multi-select",description:"",parameters:{questions:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Questions",array:!0,"default":void 0,description:"The strings that will be associated with a group of options."},options:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Options",array:!0,"default":void 0,description:"Displays options for an individual question."},required:{type:jsPsych.plugins.parameterType.BOOL,
pretty_name:"Required",array:!0,"default":!1,description:"Subject will be required to pick an option for each question."},horizontal:{type:jsPsych.plugins.parameterType.BOOL,pretty_name:"Horizontal","default":!1,description:"If true, then questions are centered and options are displayed horizontally."},preamble:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Preamble","default":"",description:"HTML formatted string to display at the top of the page above all the questions."},button_label:{type:jsPsych.plugins.parameterType.STRING,
...
var d=e("jspsych-survey-multi-select","form");c.innerHTML+='<form id="'+d+'"></form>';var d=c.querySelector("#"+d),b=e("jspsych-survey-multi-select","preamble");d.innerHTML+='<div id="'+b+'" class="'+b+'">'+a.preamble+"</div>";for(b=0;b<a.questions.length;b++){var h=[e("jspsych-survey-multi-select","question")];a.horizontal&&h.push(e("jspsych-survey-multi-select","horizontal"));d.innerHTML+='<div id="'+e("jspsych-survey-multi-select",b)+'" class="'+h.join(" ")+'"></div>';h=e("#jspsych-survey-multi-select",
b);c.querySelector(h).innerHTML+='<p id="survey-question" class="jspsych-survey-multi-select-text survey-multi-select">'+a.questions[b]+"</p>";for(var g=0;g<a.options[b].length;g++){var k=e("jspsych-survey-multi-select","option",b,g);c.querySelector(h).innerHTML+='<div id="'+k+'" class="'+e("jspsych-survey-multi-select","option")+'"></div>';var k=document.getElementById(k),m=e("jspsych-survey-multi-select","response",b),l=e("jspsych-survey-multi-select","response",b,g),p=document.createElement("label");
p.setAttribute("class","jspsych-survey-multi-select-text");p.innerHTML=a.options[b][g];p.setAttribute("for",l);var n=document.createElement("input");n.setAttribute("type","checkbox");n.setAttribute("name",m);n.setAttribute("id",l);n.setAttribute("value",a.options[b][g]);k.appendChild(p);k.insertBefore(n,p)}}d.innerHTML+='<div class="fail-message"></div>';d.innerHTML+='<input type="submit" id="jspsych-survey-multi-select-next" class="jspsych-survey-multi-select jspsych-btn"'+(a.button_label?' value="'+
a.button_label+'"':"")+"></input>";d.addEventListener("submit",function(b){b.preventDefault();b=(new Date).getTime()-q;for(var e=c.querySelectorAll("div.jspsych-survey-multi-select-question"),d={},f=[],g=0;g<e.length;g++){match=e[g];var h=[];var l=match.querySelectorAll("input[type=checkbox]:checked");for(var k=0;k<l.length;k++)currentChecked=l[k],h.push(currentChecked.value);l={};l["Q"+g]=h;Object.assign(d,l);0==h.length?f.push(!1):f.push(!0)}a.required&&f.includes(!1)?(c.querySelectorAll("input[type=checkbox]"),
c.querySelector(".fail-message").innerHTML='<span style="color: red;" class="required">'+a.required_msg+"</span>"):(b={rt:b,responses:JSON.stringify(d)},c.innerHTML="",jsPsych.finishTrial(b))});var q=(new Date).getTime()};return d}();jsPsych.plugins["survey-text"]=function(){var d={};d.info={name:"survey-text",description:"",parameters:{questions:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Questions",array:!0,"default":void 0,description:"Prompts for the subject to respond."},preamble:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Preamble","default":"",description:"HTML formatted string to display at the top of the page above all the questions."},rows:{type:jsPsych.plugins.parameterType.INT,pretty_name:"Rows",
array:!0,"default":1,description:"The number of rows for the response text box."},columns:{type:jsPsych.plugins.parameterType.INT,pretty_name:"Columns",array:!0,"default":40,description:"The number of columns for the response text box."},values:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Values",array:!0,"default":"",description:"The strings will be used to populate the response fields with editable answers."},button_label:{type:jsPsych.plugins.parameterType.STRING,pretty_name:"Button label",
"default":"Next",description:"The text that appears on the button to finish the trial."}}};d.trial=function(c,a){if("undefined"==typeof a.rows){a.rows=[];for(var e=0;e<a.questions.length;e++)a.rows.push(1)}if("undefined"==typeof a.columns)for(a.columns=[],e=0;e<a.questions.length;e++)a.columns.push(40);if("undefined"==typeof a.values)for(a.values=[],e=0;e<a.questions.length;e++)a.values.push("");for(var d='<div id="jspsych-survey-text-preamble" class="jspsych-survey-text-preamble">'+a.preamble+"</div>",
e=0;e<a.questions.length;e++)d+='<div id="jspsych-survey-text-"'+e+'" class="jspsych-survey-text-question" style="margin: 2em 0em;">',d+='<p class="jspsych-survey-text">'+a.questions[e]+"</p>",d=1==a.rows[e]?d+('<input type="text" name="#jspsych-survey-text-response-'+e+'" size="'+a.columns[e]+'">'+a.values[e]+"</input>"):d+('<textarea name="#jspsych-survey-text-response-'+e+'" cols="'+a.columns[e]+'" rows="'+a.rows[e]+'">'+a.values[e]+"</textarea>"),d+="</div>";d+='<button id="jspsych-survey-text-next" class="jspsych-btn jspsych-survey-text">'+
a.button_label+"</button>";c.innerHTML=d;c.querySelector("#jspsych-survey-text-next").addEventListener("click",function(){for(var a=(new Date).getTime()-b,d={},e=c.querySelectorAll("div.jspsych-survey-text-question"),f=0;f<e.length;f++){var l="Q"+f,p=e[f].querySelector("textarea, input").value,n={};n[l]=p;Object.assign(d,n)}a={rt:a,responses:JSON.stringify(d)};c.innerHTML="";jsPsych.finishTrial(a)});var b=(new Date).getTime()};return d}();jsPsych.plugins.video=function(){var d={};d.info={name:"video",description:"",parameters:{sources:{type:jsPsych.plugins.parameterType.VIDEO,pretty_name:"Sources",array:!0,"default":void 0,description:"The video file to play."},width:{type:jsPsych.plugins.parameterType.INT,pretty_name:"Width","default":void 0,description:"The width of the video in pixels."},height:{type:jsPsych.plugins.parameterType.INT,pretty_name:"Height","default":void 0,description:"The height of the video display in pixels."},
